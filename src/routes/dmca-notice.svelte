...
<InformationPage pagetitle={"DMCA Notice"}>
    <h1>DMCA Notice</h1>
    <p>Since we respect artist and content owner rights, it is MyReadingManga’ policy to respond to alleged infringement
        ...
        Service, please notify MyReadingManga’ copyright agent as set forth in the DMCA. For your complaint to be valid
    ...
    <ol>
        ...
        <li>Information reasonably sufficient to permit MyReadingManga to contact you, such as your address, telephone
